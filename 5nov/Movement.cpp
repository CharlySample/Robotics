...
Esta libreria contiene funciones , las cuales se comunican con la consola Python de FreeCAD para mover componentes.
 ...
 Compilacion:
 g++ -g -shared -fPIC Movement.cpp -o MoveModule.so -I/usr/include/python2.7 -lpython2.7 -lboost_python-2.7 -larmadillo -lreflapack -lrefblas
...
class Movement
{
  ...
  double w1, v;
  mat j,pref,p, phi, phi1, p1,A,B, C;
