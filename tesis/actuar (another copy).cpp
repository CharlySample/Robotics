        ...
        for(int i=0;i<=12;i++)
        {
            if(i<=11)
            {
                ...
                if(normo(i,0)!=0)
                {
                    ...
                    else if(objx(0,0) < 0 and objy(1,0) < 0  )
                    {
                        if(i<=5)
                            gan(i,0) = -3;
                        else
                    ...
                    angt(i,0) = 0.065*((atan((vely(i,0))/(velx(i,0))))+gan(i,0));
            ...
            else
            {
                ...
                velx(i,0) = ((-3*exp((normx)/(Rm)))/(Rm*normx)) * x(0,0);
                vely(i,0) = ((-3*exp((normx)/(Rm)))/(Rm*normx)) * x(1,0);
                velt(i,0) = sqrt(pow(velx(i,0),2)+pow(vely(i,0),2));
